...
import { BadgeCheck, Power, PowerOff, UserPen } from 'lucide-react';
...
interface Props {
  ...
  /** Omitted unless the signed-in admin is ADMIN or SUPER_ADMIN. */
  onEdit?: () => void;
}

export function StudentProfileHeader({ student, busy, onToggleActive, onEdit }: Props) {
