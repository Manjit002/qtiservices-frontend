...
export function SignInForm({
  ...
  const { login, user, ready } = useAuth(portal, false);
  ...
  const submit = useCallback(async () => {
    ...
    try {
      ...
      // replace, not push: the login page must not stay in history directly
      // behind the portal — that is what made Back from any portal page land
      // on the login form.
