  ...
  return (
    ...
    >
      ...
      <section>
        ...
        {/* These six categories are used verbatim in the Privacy Policy and the
            Terms of Service too, so the three pages describe one program. */}
        <ul>
          <li>Inquiries</li>
          <li>Appointments</li>
        ...
        <p>
          In practice this covers confirming your requirements, discussing pricing,
          sending secure payment links and reminders, and answering support questions.
        </p>
        <p style={{ marginBottom: 0 }}>
          Messages are sent only after you submit a request on the website and actively
          opt in. We never add a number to the program without that opt-in.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          We may share information with service providers that help us operate this
          messaging program, subject to appropriate confidentiality obligations.
        </p>
        <p style={{ marginBottom: 0 }}>
          These Messaging Terms give the detail behind the{' '}
          <Link href="/terms-of-service">SMS Terms</Link> section of our Terms of
          Service; where both describe the same thing, they are intended to say the
          same thing.
        </p>
      </section>
