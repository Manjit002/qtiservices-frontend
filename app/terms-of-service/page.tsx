...
export default function TermsOfServicePage() {
  return (
    <LegalLayout title="Terms of Service" updated="September 16, 2026">
      ...
      {/* Required SMS disclosures. This section is the summary that belongs in
          the general terms; the detailed program disclosures live on the
          Messaging Terms page, and the two are worded not to conflict. */}
      <section>
        <h2>SMS Terms</h2>
        <p>
          By opting in, you agree to receive text messages from QTIServices related to
        ...
        <p>
          SMS consent is optional and is not a condition of purchasing any goods or
          services. For more information, please review our{' '}
          <Link href="/privacy-policy">Privacy Policy</Link>.
        </p>
        <p style={{ marginBottom: 0 }}>
          The full disclosures for our SMS program — how to opt in, the message
          categories, frequency, costs and opt-out handling — are set out in our{' '}
          <Link href="/messaging-terms">Messaging Terms</Link>, which form part of these
          Terms.
        </p>
      </section>
