...
export const API = {
  ...
  students: {
    ...
    /**
     * PUT /admin/students/{id}/profile — body { name, email, phone }.
     * @PreAuthorize ADMIN / SUPER_ADMIN. Returns the updated StudentProfileDTO,
     * which is the ONLY authoritative read of a student profile available to
     * the admin portal — there is no GET for a single student.
     */
    updateProfile: (studentId: number) => `/admin/students/${studentId}/profile`,
